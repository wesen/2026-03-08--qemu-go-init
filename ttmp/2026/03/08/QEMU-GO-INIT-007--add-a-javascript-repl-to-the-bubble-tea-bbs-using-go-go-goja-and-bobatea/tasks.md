...
- [x] Add repo-local Go module wiring for `github.com/go-go-golems/go-go-goja` and `github.com/go-go-golems/bobatea`.
- [x] Add a reusable integration package that owns the JS evaluator, Bobatea bus, and program attachment lifecycle.
- [x] Refactor the BBS app to support a dedicated REPL mode and mode-switching UX.
